    ...
    <div class="col-9" style="background-color:;">
        <div class="col-12 d-flex flex-row" style="height: 4rem;">
            <div class="col-5 d-flex justify-content-start align-items-center">
                <img src="{{asset('img/design/Inicio/logo.png')}}" style="height: 100%;" alt="">
            </div>
            ...
            <div class="col-5 d-flex justify-content-end align-items-center">
                ...
                <img src="{{asset('img/design/Inicio/carrito.png')}}" style="height: 40%; margin-left: 3rem;" alt="">
            </div>
        </div>
        ...
        <div class="col-12 d-flex flex-row justify-content-center align-items-center" style="height: 4rem;">
            ...
            <div class="col-6 d-flex flex-row justify-content-center align-items-center" style="height: 100%">
                ...
                <div class="col-3 d-flex justify-content-center align-items-center footer" style="height: 100%">
                    <img class="px-1" src="{{asset('img/design/Inicio/whats.png')}}" alt="" style="height: 40%">
                    <img class="px-1" src="{{asset('img/design/Inicio/insta.png')}}" alt="" style="height: 40%">
                    <img class="px-1" src="{{asset('img/design/Inicio/face.png')}}" alt="" style="height: 40%">
                    <img class="px-1" src="{{asset('img/design/Inicio/tik-tok.png')}}" alt="" style="height: 40%">
                    <img class="px-1" src="{{asset('img/design/Inicio/youtube.png')}}" alt="" style="height: 40%">
                </div>
            </div>
        </div>
    </div>
