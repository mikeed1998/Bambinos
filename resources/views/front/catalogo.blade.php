...
<div class="col-4 px-3 my-2" style="height: 30rem;">
    <a href="{{route('brincolin')}}" class="col-12 d-flex flex-column align-items-center justify-content-center" style="height: 100%; background-color: #ffffff; border-radius: 33px">
