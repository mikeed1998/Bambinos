...
{{-- CONTENIDO DE LA PAGINA --}}
    ...
    <div class="col-12 pb-5 d-flex justify-content-center align-items-center " style="">
        <form id="payment-form" action="{{route('procesarPago')}}" method="POST" class="container d-flex flex-wrap">
                <div class="col-12 col-md-12 col-lg-7 card py-2 px-2 mx-0 mx-md-0 mx-lg-2" style="height: 550px; overflow: auto; border-radius: 26px; border:; background: ; ">
                ...
                <div class="col-12 col-md-12 col-lg-4 card p-3 d-flex justify-content-between" style=" height: 350px; border-radius: 26px; border:none; box-shadow: 1px 1px 10px rgba(0, 0, 0, 0.11);">
...
{{-- JAVASCRIPT EXTRAS --}}
    ...
    <script type="text/javascript">
        ...
        const config = {
          ...
          publicKey: "key_ExCRhEUcFipRhmET3V6FWRC",     //"key_DBhh1a7u2Fn5GVBD04mMN3T", Llaves: https://developers.conekta.com/docs/como-obtener-tus-api-keys
