...
{{-- CONTENIDO DE LA PAGINA --}}
    ...
    <div class="col-12 text-center d-flex justify-content-center align-items-center flex-column mb-4">
        ...
        <div class="col-12 d-flex align-items-center justify-content-center mb-5" style="position: relative;">
            <div class="col-12 d-flex txt-card-2 align-items-center justify-content-center">DATOS PARA TU ENVIO</div>
            <div class="col-12 d-flex txt-card align-items-center justify-content-center">DATOS PARA TU ENVIO</div>
        </div>
</div>

    @if($car == 1)
    <div class="col-12 pb-5 d-flex justify-content-center align-items-center " style="">
        <form action="{{route('pasarelaPago')}}" method="POST" class="container d-flex flex-wrap flex-md-wrap flex-lg-row">
                <div class="col-12 col-md-12 col-lg-7 card py-2 px-2 mx-0 mx-lg-2" style="main-height: 400px; overflow: auto; border-radius: 26px; border:; ">
                    <div class="col-12 text-center mb-3">
                        <h5>Verifica que tus datos sean correctos</h5>
                    </div>
                    <div class="col-12 ">
                        <div class="col-12 my-3 mt-2 d-flex flex-wrap px-4">
                        ...
                        <div class="col-12 mb-3 d-flex flex-wrap px-4">
                            <div class="col-12 col-md-12 col-lg-6 px-5">
                ...
                <div class="col-12 col-md-12 col-lg-4 card p-3 d-flex justify-content-between" style=" height: 450px; border-radius: 26px; border:none; box-shadow: 1px 1px 10px rgba(0, 0, 0, 0.11);">
...
<script>
    const telefonoInput = document.querySelector('.usuario_txt_change'); // Obtén el campo de entrada
    ...
    telefonoInput.addEventListener('blur', function() {
        ...
        if (regex.test(telefonoValue)) {
            telefonoError.textContent = ''; // Borra el mensaje de error si la longitud es la adecuada
        } else {
