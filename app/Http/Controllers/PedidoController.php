...
class PedidoController extends Controller
{
    ...
    public function changeStatus(Request $request){
        ...
        if (Pedido::find($request->id)->update(["estatus" => "$request->estatus"])) {
			\Toastr::success('Se actualizo el estado del pedido');
            return redirect()->back();
        }else {
	...
	public function detallesPU(Request $request){
		...
		$dom = Domicilio::where('user', $user->id)->first();
		...
		<div class="col-12">
		<div class="col-12 text-center" style="font-size: 2rem; font-weight: bold;">Informacion de pedido</div>
	</div>
		<div class="col-12 px-2 d-flex flex-row">
				<div class="col-8 card py-2 px-2 " style="main-height: 400px; max-height: 500px; overflow: auto; border-radius: 26px;">';
		...
		<div class="col-12 modal-body">
			<div class="col-12 text-center" style="font-size: 2rem; font-weight: bold;">Informacion de envio</div>
			<div class="col-12 card px-3 pt-3" style="border-radius: 13px">
			<div class="col-12 d-flex flex-wrap">
			<div class="col-6 d-flex flex-column">
				<div class="card col-12 d-flex flex-row mb-3 py-2" style="box-shadow: none; background-color: rgb(233, 233, 233); border-radius: 13px">
					<div class="col-3 text-center" style="font-weight: bold">Cliente:</div>
					<div class="col-8 text-start">'.$user->name.' '.$user->lastname.'</div>
				</div>
				<div class="card col-12 d-flex flex-row mb-3 py-2" style="box-shadow: none; background-color: rgb(233, 233, 233); border-radius: 13px">
					<div class="col-3 text-center" style="font-weight: bold">Alias:</div>
					<div class="col-8 text-start">'.$dom->alias.'</div>
				</div>
				<div class="card col-12 d-flex flex-row mb-3 py-2" style="box-shadow: none; background-color: rgb(233, 233, 233); border-radius: 13px">
					<div class="col-3 text-center" style="font-weight: bold">Calle:</div>
					<div class="col-8 text-start">'.$dom->calle.'</div>
				</div>
				<div class="card col-12 d-flex flex-row mb-3 py-2" style="box-shadow: none; background-color: rgb(233, 233, 233); border-radius: 13px">
					<div class="col-3 text-center" style="font-weight: bold">Entre calles:</div>
					<div class="col-8 text-start">'.$dom->entrecalles.'</div>
				</div>
				<div class="card col-12 d-flex flex-row mb-3 py-2" style="box-shadow: none; background-color: rgb(233, 233, 233); border-radius: 13px">
					<div class="col-3 text-center" style="font-weight: bold">CP:</div>
					<div class="col-8 text-start">'.$dom->cp.'</div>
				</div>
				<div class="card col-12 d-flex flex-row mb-3 py-2" style="box-shadow: none; background-color: rgb(233, 233, 233); border-radius: 13px">
					<div class="col-3 text-center" style="font-weight: bold">Estado:</div>
					<div class="col-8 text-start">'.$dom->estado.'</div>
				</div>
			</div>
			<div class="col-6 d-flex flex-column">
				<div class="card col-12 d-flex flex-row mb-3 py-2" style="box-shadow: none; background-color: rgb(233, 233, 233); border-radius: 13px">
					<div class="col-3 text-center" style="font-weight: bold">Correo:</div>
					<div class="col-8 text-start">'.$user->email.'</div>
				</div>
				<div class="card col-12 d-flex flex-row mb-3 py-2" style="box-shadow: none; background-color: rgb(233, 233, 233); border-radius: 13px">
					<div class="col-3 text-center" style="font-weight: bold">Telefono:</div>
					<div class="col-8 text-start">'.$user->telefono.'</div>
				</div>
				<div class="card col-12 d-flex flex-row mb-3 py-2" style="box-shadow: none; background-color: rgb(233, 233, 233); border-radius: 13px">
					<div class="col-3 text-center" style="font-weight: bold">No.Ext:</div>
					<div class="col-8 text-start">'.$dom->numext.'</div>
				</div>
				<div class="card col-12 d-flex flex-row mb-3 py-2" style="box-shadow: none; background-color: rgb(233, 233, 233); border-radius: 13px">
				<div class="col-3 text-center" style="font-weight: bold">No.Int:</div>
				<div class="col-8 text-start">'.$dom->numint.'</div>
			</div>
				<div class="card col-12 d-flex flex-row mb-3 py-2" style="box-shadow: none; background-color: rgb(233, 233, 233); border-radius: 13px">
					<div class="col-3 text-center" style="font-weight: bold">Colonia:</div>
					<div class="col-8 text-start">'.$dom->colonia.'</div>
				</div>
				<div class="card col-12 d-flex flex-row mb-3 py-2" style="box-shadow: none; background-color: rgb(233, 233, 233); border-radius: 13px">
					<div class="col-3 text-center" style="font-weight: bold">Ciudad:</div>
					<div class="col-8 text-start">'.$dom->municipio.'</div>
				</div>
			</div>
			</div>
			</div>';
